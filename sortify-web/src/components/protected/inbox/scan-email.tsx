				...
				<div className="space-y-4">
					...
					<div>
						...
						<p className="text-blue-100 mb-6 max-w-2xl mx-auto">
							Click below to scan your unread emails and
							automatically sort them into your folders using AI
							classification. (Will only read your first 500
							unread emails for now.)
						</p>
					</div>
					<Button
